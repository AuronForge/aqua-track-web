...
export const TRANSLATIONS: Record<LanguageCode, TranslationDictionary> = {
  pt: {
    ...
    profileContactPhoneInvalid: 'Informe um telefone válido.',
    ...
    preferencesLanguageLabel: 'Idioma Preferido',
    preferencesLanguageHint: 'Definir idioma padrão do aplicativo',
    changePasswordModalTitle: 'Alterar Senha',
    changePasswordModalSubtitle: 'Atualize sua senha para manter sua conta segura.',
    changePasswordCurrentPasswordLabel: 'Senha Atual',
    changePasswordCurrentPasswordPlaceholder: 'Digite sua senha atual',
    changePasswordNewPasswordLabel: 'Nova Senha',
    changePasswordNewPasswordPlaceholder: 'Digite sua nova senha',
    changePasswordConfirmNewPasswordLabel: 'Confirmar Nova Senha',
    changePasswordConfirmNewPasswordPlaceholder: 'Confirme sua nova senha',
    changePasswordRequirementsTitle: 'REQUISITOS DA SENHA',
    changePasswordRequirementMinLength: 'Mínimo de 8 caracteres',
    changePasswordRequirementUppercase: '1 letra maiúscula',
    changePasswordRequirementNumber: '1 número',
    changePasswordRequirementSpecial: '1 caractere especial',
    changePasswordUpdateLabel: 'Atualizar Senha',
    changePasswordUpdatingLabel: 'Atualizando...',
    changePasswordSuccessMessage: 'Senha atualizada com sucesso.',
    changePasswordErrorMessage: 'Não foi possível atualizar sua senha agora. Tente novamente.',
    changePasswordCurrentPasswordIncorrect: 'A senha atual não confere. Revise e tente novamente.',
    changePasswordNewPasswordDifferent: 'A nova senha deve ser diferente da senha atual.',
    changePasswordRequirementsError: 'Sua nova senha precisa atender a todos os requisitos.',
    changePasswordShowCurrentPassword: 'Mostrar senha atual',
    changePasswordHideCurrentPassword: 'Ocultar senha atual',
    changePasswordShowNewPassword: 'Mostrar nova senha',
    changePasswordHideNewPassword: 'Ocultar nova senha',
    changePasswordShowConfirmPassword: 'Mostrar confirmação da nova senha',
    changePasswordHideConfirmPassword: 'Ocultar confirmação da nova senha',
    ...
    preferencesPhAlertsLabel: 'Alertas de pH',
    preferencesPhAlertsHint: 'Receber alertas quando o pH sair da faixa esperada',
    preferencesTemperatureAlertsLabel: 'Alertas de Temperatura',
    preferencesTemperatureAlertsHint: 'Receber alertas quando a temperatura variar demais',
    preferencesAmmoniaAlertsLabel: 'Alertas de Amônia',
    preferencesAmmoniaAlertsHint: 'Receber alertas para níveis críticos de amônia',
    preferencesNitriteAlertsLabel: 'Alertas de Nitrito',
    preferencesNitriteAlertsHint: 'Receber alertas para níveis críticos de nitrito',
    preferencesNitrateAlertsLabel: 'Alertas de Nitrato',
    preferencesNitrateAlertsHint: 'Receber alertas para níveis críticos de nitrato',
    ...
    deleteAccountRequestLabel: 'Solicitar Exclusão',
    ...
    deleteAccountRequestPending:
      'Sua solicitação de exclusão já foi enviada. Nossa equipe irá analisar o pedido.',
    deleteAccountConfirmWord: 'EXCLUIR',
    deleteAccountConfirmWordLabel: 'Digite EXCLUIR para confirmar',
    deleteAccountRequestModalTitle: 'Solicitar Exclusão da Conta',
    deleteAccountRequestModalSubtitle:
      'Envie uma solicitação de exclusão e nossa equipe continuará o atendimento.',
    deleteAccountRequestReasonLabel: 'Motivo da solicitação',
    deleteAccountRequestReasonPlaceholder: 'Conte-nos, se quiser, por que deseja excluir sua conta',
    deleteAccountRequestReasonHint: 'Opcional. Seu feedback nos ajuda a melhorar o AquaTrack.',
    deleteAccountRequestSubmitLabel: 'Solicitar Exclusão',
    deleteAccountRequestSubmittingLabel: 'Enviando solicitação...',
    deleteAccountRequestSuccessMessage: 'Sua solicitação de exclusão foi enviada com sucesso.',
    deleteAccountRequestErrorMessage:
      'Não foi possível enviar sua solicitação de exclusão agora. Tente novamente.',
  },
  ...
  en: {
    ...
    preferencesLanguageLabel: 'Preferred Language',
    preferencesLanguageHint: 'Set the default language of the app',
    changePasswordModalTitle: 'Change Password',
    changePasswordModalSubtitle: 'Update your password to keep your account secure.',
    changePasswordCurrentPasswordLabel: 'Current Password',
    changePasswordCurrentPasswordPlaceholder: 'Enter current password',
    changePasswordNewPasswordLabel: 'New Password',
    changePasswordNewPasswordPlaceholder: 'Enter new password',
    changePasswordConfirmNewPasswordLabel: 'Confirm New Password',
    changePasswordConfirmNewPasswordPlaceholder: 'Confirm new password',
    changePasswordRequirementsTitle: 'PASSWORD REQUIREMENTS',
    changePasswordRequirementMinLength: 'Minimum 8 characters',
    changePasswordRequirementUppercase: '1 uppercase letter',
    changePasswordRequirementNumber: '1 number',
    changePasswordRequirementSpecial: '1 special character',
    changePasswordUpdateLabel: 'Update Password',
    changePasswordUpdatingLabel: 'Updating...',
    changePasswordSuccessMessage: 'Password updated successfully.',
    changePasswordErrorMessage: "We couldn't update your password right now. Please try again.",
    changePasswordCurrentPasswordIncorrect:
      'Current password is incorrect. Please review and try again.',
    changePasswordNewPasswordDifferent:
      'New password must be different from your current password.',
    changePasswordRequirementsError: 'Your new password must meet all requirements.',
    changePasswordShowCurrentPassword: 'Show current password',
    changePasswordHideCurrentPassword: 'Hide current password',
    changePasswordShowNewPassword: 'Show new password',
    changePasswordHideNewPassword: 'Hide new password',
    changePasswordShowConfirmPassword: 'Show confirm new password',
    changePasswordHideConfirmPassword: 'Hide confirm new password',
    ...
    preferencesPhAlertsLabel: 'pH Alerts',
    preferencesPhAlertsHint: 'Receive alerts when pH goes outside the expected range',
    preferencesTemperatureAlertsLabel: 'Temperature Alerts',
    preferencesTemperatureAlertsHint: 'Receive alerts when temperature varies too much',
    preferencesAmmoniaAlertsLabel: 'Ammonia Alerts',
    preferencesAmmoniaAlertsHint: 'Receive alerts for critical ammonia levels',
    preferencesNitriteAlertsLabel: 'Nitrite Alerts',
    preferencesNitriteAlertsHint: 'Receive alerts for critical nitrite levels',
    preferencesNitrateAlertsLabel: 'Nitrate Alerts',
    preferencesNitrateAlertsHint: 'Receive alerts for critical nitrate levels',
    ...
    deleteAccountRequestLabel: 'Request Deletion',
    deleteAccountMessage:
    ...
    deleteAccountRequestPending:
      'Your deletion request has already been sent. Our team will review it shortly.',
    deleteAccountConfirmWord: 'DELETE',
    deleteAccountConfirmWordLabel: 'Type DELETE to confirm',
    deleteAccountRequestModalTitle: 'Request Account Deletion',
    deleteAccountRequestModalSubtitle:
      'Send your deletion request and our team will continue the process.',
    deleteAccountRequestReasonLabel: 'Reason for the request',
    deleteAccountRequestReasonPlaceholder:
      'Tell us, if you want, why you would like to delete your account',
    deleteAccountRequestReasonHint: 'Optional. Your feedback helps us improve AquaTrack.',
    deleteAccountRequestSubmitLabel: 'Request Deletion',
    deleteAccountRequestSubmittingLabel: 'Sending request...',
    deleteAccountRequestSuccessMessage: 'Your account deletion request has been sent.',
    deleteAccountRequestErrorMessage:
  ...
  es: {
    ...
    preferencesLanguageLabel: 'Idioma Preferido',
    preferencesLanguageHint: 'Define el idioma predeterminado de la aplicación',
    changePasswordModalTitle: 'Cambiar Contraseña',
    changePasswordModalSubtitle: 'Actualiza tu contraseña para mantener segura tu cuenta.',
    changePasswordCurrentPasswordLabel: 'Contraseña Actual',
    changePasswordCurrentPasswordPlaceholder: 'Ingresa tu contraseña actual',
    changePasswordNewPasswordLabel: 'Nueva Contraseña',
    changePasswordNewPasswordPlaceholder: 'Ingresa tu nueva contraseña',
    changePasswordConfirmNewPasswordLabel: 'Confirmar Nueva Contraseña',
    changePasswordConfirmNewPasswordPlaceholder: 'Confirma tu nueva contraseña',
    changePasswordRequirementsTitle: 'REQUISITOS DE LA CONTRASEÑA',
    changePasswordRequirementMinLength: 'Mínimo de 8 caracteres',
    changePasswordRequirementUppercase: '1 letra maiúscula',
    changePasswordRequirementNumber: '1 número',
    changePasswordRequirementSpecial: '1 carácter especial',
    changePasswordUpdateLabel: 'Actualizar Contraseña',
    changePasswordUpdatingLabel: 'Actualizando...',
    changePasswordSuccessMessage: 'Contraseña actualizada correctamente.',
    changePasswordErrorMessage: 'No se pudo actualizar tu contraseña ahora. Inténtalo de nuevo.',
    changePasswordCurrentPasswordIncorrect:
      'La contraseña actual no coincide. Revísala e inténtalo de nuevo.',
    changePasswordNewPasswordDifferent: 'La nueva contraseña debe ser diferente de la actual.',
    changePasswordRequirementsError: 'Tu nueva contraseña debe cumplir todos los requisitos.',
    changePasswordShowCurrentPassword: 'Mostrar contraseña actual',
    changePasswordHideCurrentPassword: 'Ocultar contraseña actual',
    changePasswordShowNewPassword: 'Mostrar nueva contraseña',
    changePasswordHideNewPassword: 'Ocultar nueva contraseña',
    changePasswordShowConfirmPassword: 'Mostrar confirmación de la nueva contraseña',
    changePasswordHideConfirmPassword: 'Ocultar confirmación de la nueva contraseña',
    preferencesUnitsGroup: 'Unidades',
    preferencesTemperatureLabel: 'Temperatura',
    ...
    preferencesPhAlertsLabel: 'Alertas de pH',
    preferencesPhAlertsHint: 'Recibir alertas cuando el pH salga del rango esperado',
    preferencesTemperatureAlertsLabel: 'Alertas de Temperatura',
    preferencesTemperatureAlertsHint: 'Recibir alertas cuando la temperatura varíe demasiado',
    preferencesAmmoniaAlertsLabel: 'Alertas de Amoníaco',
    preferencesAmmoniaAlertsHint: 'Recibir alertas por niveles críticos de amoníaco',
    preferencesNitriteAlertsLabel: 'Alertas de Nitrito',
    preferencesNitriteAlertsHint: 'Recibir alertas por niveles críticos de nitrito',
    preferencesNitrateAlertsLabel: 'Alertas de Nitrato',
    preferencesNitrateAlertsHint: 'Recibir alertas por niveles críticos de nitrato',
    ...
    deleteAccountRequestLabel: 'Solicitar Eliminación',
    deleteAccountMessage:
    ...
    deleteAccountRequestPending:
      'Tu solicitud de eliminación ya fue enviada. Nuestro equipo revisará el pedido.',
    deleteAccountConfirmWord: 'ELIMINAR',
    deleteAccountConfirmWordLabel: 'Escribe ELIMINAR para confirmar',
    deleteAccountRequestModalTitle: 'Solicitar Eliminación de la Cuenta',
    deleteAccountRequestModalSubtitle:
      'Envía tu solicitud de eliminación y nuestro equipo continuará el proceso.',
    deleteAccountRequestReasonLabel: 'Motivo de la solicitud',
    deleteAccountRequestReasonPlaceholder:
      'Cuéntanos, si quieres, por qué deseas eliminar tu cuenta',
    deleteAccountRequestReasonHint: 'Opcional. Tus comentarios nos ayudan a mejorar AquaTrack.',
    deleteAccountRequestSubmitLabel: 'Solicitar Eliminación',
    deleteAccountRequestSubmittingLabel: 'Enviando solicitud...',
    deleteAccountRequestSuccessMessage:
      'Tu solicitud de eliminación de la cuenta fue enviada correctamente.',
    deleteAccountRequestErrorMessage:
      'No se pudo enviar tu solicitud de eliminación ahora. Inténtalo de nuevo.',
  },
};
