...
export const TRANSLATIONS: Record<LanguageCode, TranslationDictionary> = {
  pt: {
    ...
    homeAquariumFiltersSearchLabel: 'Buscar por nome',
    homeAquariumFiltersSearchPlaceholder: 'Ex.: Comunitário, Plantado, Recife',
    homeAquariumFiltersTypeLabel: 'Tipo de aquário',
    homeAquariumFiltersTypePlaceholder: 'Todos os tipos',
    homeAquariumFiltersDateFromLabel: 'Data inicial',
    homeAquariumFiltersDateToLabel: 'Data final',
    homeAquariumFiltersDatePlaceholder: 'Selecione a data',
    homeAquariumFiltersDateHint:
      'Filtro de data será ativado quando a API enviar a data do aquário.',
    homeAquariumFiltersEmptyTitle: 'Nenhum aquário encontrado',
    homeAquariumFiltersEmptyDesc: 'Ajuste a busca ou o tipo selecionado para encontrar um aquário.',
    ...
    aquariumFormTitle: 'Adicionar Novo Aquário',
    aquariumCreateSubtitle:
      'Configure um novo aquário para começar a acompanhar os parâmetros da água',
    aquariumCreateBackToAquariums: 'Voltar para Aquários',
    aquariumCreateBasicInfoTitle: 'Informações Básicas',
    aquariumCreateNameLabel: 'Nome do Aquário',
    aquariumCreateNamePlaceholder: 'ex.: Comunitário 60L, Plantado da Sala, Reef Paradise',
    aquariumCreateTypeLabel: 'Tipo de Aquário',
    aquariumCreateTypeHint: 'Selecione a configuração que melhor representa o seu aquário.',
    aquariumCreateTypeSelectWaterTypeHint:
      'Selecione primeiro o tipo de água para liberar os tipos de aquário compatíveis.',
    aquariumCreateTypeLoadingHint: 'Carregando os tipos de aquário disponíveis...',
    aquariumCreateTypeLoadErrorHint: 'Não foi possível carregar os tipos de aquário no momento.',
    aquariumCreateTypeBreeding: 'Reprodução',
    aquariumCreateTypeCrabs: 'Caranguejos',
    aquariumCreateTypeCommunity: 'Comunitário',
    aquariumCreateTypeCommunityTank: 'Aquário Comunitário',
    aquariumCreateTypeHospital: 'Hospital',
    aquariumCreateTypeLake: 'Lago',
    aquariumCreateTypeOther: 'Outro',
    aquariumCreateTypePaludarium: 'Paludário',
    aquariumCreateTypeFreshwater: 'Água Doce',
    aquariumCreateTypeFreshwaterDescription: 'Aquário padrão de água doce',
    aquariumCreateTypePlanted: 'Plantado',
    aquariumCreateTypePlantedTank: 'Aquário Plantado',
    aquariumCreateTypePlantedDescription: 'Aquascaping com plantas vivas',
    aquariumCreateTypeReef: 'Recife',
    aquariumCreateTypeReefTank: 'Aquário de Recife',
    aquariumCreateTypeSaltwater: 'Água Salgada',
    aquariumCreateTypeSaltwaterDescription: 'Aquário marinho ou de recife',
    aquariumCreateTypeShrimp: 'Aquário de Camarões',
    aquariumCreateTypeShrimpTank: 'Aquário de Camarões',
    aquariumCreateTypeShrimpDescription: 'Especializado para reprodução de camarões',
    aquariumCreateTypeSpeciesOnly: 'Apenas Uma Espécie',
    aquariumCreateTypeTurtle: 'Aquário de Tartarugas',
    aquariumCreateTypeTurtleTank: 'Aquário de Tartarugas',
    aquariumCreateTypeTurtleDescription: 'Configuração para tartarugas aquáticas',
    aquariumCreateWaterTypeLabel: 'Tipo de Água',
    aquariumCreateWaterTypeHint: 'Selecione o tipo de água utilizado neste aquário.',
    aquariumCreateWaterTypeLoadingHint: 'Carregando os tipos de água disponíveis...',
    aquariumCreateWaterTypeLoadErrorHint: 'Não foi possível carregar os tipos de água no momento.',
    aquariumCreateWaterTypeFreshwaterDescription: 'Ideal para peixes e plantas de água doce',
    aquariumCreateWaterTypeSaltwaterDescription: 'Indicado para aquários marinhos ou de recife',
    aquariumCreateWaterTypeBrackishDescription: 'Mistura de água doce e salgada',
    aquariumCreateSetupDateLabel: 'Data de Início',
    aquariumCreateSetupDatePlaceholder: 'Selecione a data',
    aquariumCreateDimensionsTitle: 'Dimensões',
    aquariumCreateDimensionsSubtitle:
      'Escolha entre informar as dimensões físicas do aquário ou apenas o volume total.',
    aquariumCreateDimensionModeLabel: 'Informar dimensões físicas',
    aquariumCreateDimensionModeHint: 'Ative para preencher largura, comprimento e altura.',
    aquariumCreateDimensionModeVolumeHint: 'Desative para informar apenas o volume total.',
    aquariumCreateLengthLabel: 'Comprimento (cm)',
    aquariumCreateLengthPlaceholder: 'ex.: 90',
    aquariumCreateWidthLabel: 'Largura (cm)',
    aquariumCreateWidthPlaceholder: 'ex.: 45',
    aquariumCreateHeightLabel: 'Altura (cm)',
    aquariumCreateHeightPlaceholder: 'ex.: 50',
    aquariumCreateVolumeLabel: 'Volume (L)',
    aquariumCreateVolumePlaceholder: 'ex.: 72',
    aquariumCreateVolumeCalculatedLabel: 'Volume calculado',
    aquariumCreateVolumeProvidedLabel: 'Volume informado',
    aquariumCreateVolumeUnitLiters: 'litros',
    aquariumCreateVolumeFormula: 'Fórmula: comprimento × largura × altura ÷ 1000',
    aquariumCreateDisplayParametersTitle: 'Parâmetros no Dashboard',
    aquariumCreateDisplayParametersSubtitle:
    ...
    aquariumCreateDescriptionPlaceholder: 'Adicione notas ou observações sobre este aquário...',
    aquariumCreatePhotoTitle: 'Foto do Aquário',
    aquariumCreatePhotoSubtitle: 'Opcional: adicione uma foto do seu aquário.',
    aquariumCreatePhotoDropLabel: 'Solte sua imagem aqui ou',
    aquariumCreatePhotoBrowseLabel: 'procure no computador',
    aquariumCreatePhotoHint: 'Formatos aceitos: JPG, PNG, WebP. Tamanho máximo 5MB.',
    ...
    aquariumListInstalledMonthPlural: '{{count}} meses atrás',
    aquariumListInstalledYearSingular: '1 ano atrás',
    aquariumListInstalledYearPlural: '{{count}} anos atrás',
    aquariumListRecentParametersTitle: 'Parâmetros recentes',
    aquariumListParameterPh: 'pH',
    aquariumListParameterTemperature: 'Temp',
    aquariumListParameterNitrate: 'NO3',
    aquariumStatusActive: 'Ativo',
    aquariumStatusInactive: 'Inativo',
    aquariumStatusArchived: 'Arquivado',
    aquariumListDetailsAction: 'Ver Detalhes',
    aquariumListDetailsActionAria: 'Ver detalhes do aquário {{name}}',
    aquariumListTypeLoadingHint: 'Carregando tipos...',
    aquariumListTypeLoadErrorHint:
      'Não foi possível carregar os tipos de aquário. Tente novamente.',
    aquariumListLoadErrorTitle: 'Não foi possível carregar os aquários',
    aquariumListLoadErrorDescription:
      'Tente novamente em instantes para buscar a lista atualizada da API.',
    aquariumListTotalLabel: 'Total',
    aquariumListCombinedVolumeLabel: 'Volume combinado',
    aquariumListAquariumSingular: 'aquário',
    aquariumListAquariumPlural: 'aquários',
    aquariumListEmptyTitle: 'Nenhum aquário cadastrado',
    aquariumListEmptyDescription:
      'Adicione seu primeiro aquário para começar a monitorar os parâmetros da água.',
  ...
  en: {
    ...
    homeAquariumFiltersSearchLabel: 'Search by name',
    homeAquariumFiltersSearchPlaceholder: 'Example: Community, Planted, Reef',
    homeAquariumFiltersTypeLabel: 'Aquarium type',
    homeAquariumFiltersTypePlaceholder: 'All types',
    homeAquariumFiltersDateFromLabel: 'Start date',
    homeAquariumFiltersDateToLabel: 'End date',
    homeAquariumFiltersDatePlaceholder: 'Select a date',
    homeAquariumFiltersDateHint:
      'Date filtering will be enabled once the API sends the aquarium date.',
    homeAquariumFiltersEmptyTitle: 'No aquariums found',
    homeAquariumFiltersEmptyDesc: 'Adjust the search term or selected type to find an aquarium.',
    ...
    // Aquarium — create page
    aquariumFormTitle: 'Add New Aquarium',
    aquariumCreateSubtitle: 'Configure a new aquarium to start tracking water parameters',
    aquariumCreateBackToAquariums: 'Back to Aquariums',
    aquariumCreateBasicInfoTitle: 'Basic Information',
    aquariumCreateNameLabel: 'Aquarium Name',
    aquariumCreateNamePlaceholder: 'e.g., Community 60L, Living Room Planted, Reef Paradise',
    aquariumCreateTypeLabel: 'Aquarium Type',
    aquariumCreateTypeHint: 'Select the setup that best represents your aquarium.',
    aquariumCreateTypeSelectWaterTypeHint:
      'Select a water type first to unlock compatible aquarium types.',
    aquariumCreateTypeLoadingHint: 'Loading available aquarium types...',
    aquariumCreateTypeLoadErrorHint: 'Could not load aquarium types right now.',
    aquariumCreateTypeBreeding: 'Breeding',
    aquariumCreateTypeCrabs: 'Crabs',
    aquariumCreateTypeCommunity: 'Community',
    aquariumCreateTypeCommunityTank: 'Community Tank',
    aquariumCreateTypeHospital: 'Hospital',
    aquariumCreateTypeLake: 'Lake',
    aquariumCreateTypeOther: 'Other',
    aquariumCreateTypePaludarium: 'Paludarium',
    aquariumCreateTypeFreshwater: 'Freshwater',
    aquariumCreateTypeFreshwaterDescription: 'Standard freshwater aquarium',
    aquariumCreateTypePlanted: 'Planted',
    aquariumCreateTypePlantedTank: 'Planted Tank',
    aquariumCreateTypePlantedDescription: 'Aquascaping with live plants',
    aquariumCreateTypeReef: 'Reef',
    aquariumCreateTypeReefTank: 'Reef Tank',
    aquariumCreateTypeSaltwater: 'Saltwater',
    aquariumCreateTypeSaltwaterDescription: 'Marine or reef aquarium',
    aquariumCreateTypeShrimp: 'Shrimp Aquarium',
    aquariumCreateTypeShrimpTank: 'Shrimp Tank',
    aquariumCreateTypeShrimpDescription: 'Specialized for shrimp breeding',
    aquariumCreateTypeSpeciesOnly: 'Species Only',
    aquariumCreateTypeTurtle: 'Turtle Aquarium',
    aquariumCreateTypeTurtleTank: 'Turtle Tank',
    aquariumCreateTypeTurtleDescription: 'Setup for aquatic turtles',
    aquariumCreateWaterTypeLabel: 'Water Type',
    aquariumCreateWaterTypeHint: 'Select the type of water used in this aquarium.',
    aquariumCreateWaterTypeLoadingHint: 'Loading available water types...',
    aquariumCreateWaterTypeLoadErrorHint: 'Could not load water types right now.',
    aquariumCreateWaterTypeFreshwaterDescription: 'Ideal for freshwater fish and plants',
    aquariumCreateWaterTypeSaltwaterDescription: 'Recommended for marine or reef aquariums',
    aquariumCreateWaterTypeBrackishDescription: 'A mix of freshwater and saltwater',
    aquariumCreateSetupDateLabel: 'Start Date',
    aquariumCreateSetupDatePlaceholder: 'Select a date',
    aquariumCreateDimensionsTitle: 'Dimensions',
    aquariumCreateDimensionsSubtitle:
      'Choose whether to provide physical aquarium dimensions or just the total volume.',
    aquariumCreateDimensionModeLabel: 'Use physical dimensions',
    aquariumCreateDimensionModeHint: 'Enable to fill in width, length, and height.',
    aquariumCreateDimensionModeVolumeHint: 'Disable to provide only the total volume.',
    aquariumCreateLengthLabel: 'Length (cm)',
    aquariumCreateLengthPlaceholder: 'e.g., 90',
    aquariumCreateWidthLabel: 'Width (cm)',
    aquariumCreateWidthPlaceholder: 'e.g., 45',
    aquariumCreateHeightLabel: 'Height (cm)',
    aquariumCreateHeightPlaceholder: 'e.g., 50',
    aquariumCreateVolumeLabel: 'Volume (L)',
    aquariumCreateVolumePlaceholder: 'e.g., 72',
    aquariumCreateVolumeCalculatedLabel: 'Calculated volume',
    aquariumCreateVolumeProvidedLabel: 'Provided volume',
    aquariumCreateVolumeUnitLiters: 'liters',
    aquariumCreateVolumeFormula: 'Formula: length × width × height ÷ 1000',
    aquariumCreateDisplayParametersTitle: 'Dashboard Parameters',
    aquariumCreateDisplayParametersSubtitle:
    ...
    aquariumCreateDescriptionPlaceholder: 'Add notes or observations about this aquarium...',
    aquariumCreatePhotoTitle: 'Aquarium Photo',
    aquariumCreatePhotoSubtitle: 'Optional: add a photo of your aquarium.',
    aquariumCreatePhotoDropLabel: 'Drop your image here, or',
    aquariumCreatePhotoBrowseLabel: 'browse',
    aquariumCreatePhotoHint: 'Accepted formats: JPG, PNG, WebP. Max size 5MB.',
    ...
    aquariumListPageSubtitle: 'Monitor and review the overall status of your aquariums.',
    aquariumListAddAction: 'Add Aquarium',
    aquariumListVolumeLabel: 'Volume',
    aquariumListInstalledLabel: 'Installed',
    aquariumListInstalledMonthSingular: '1 month ago',
    aquariumListInstalledMonthPlural: '{{count}} months ago',
    aquariumListInstalledYearSingular: '1 year ago',
    aquariumListInstalledYearPlural: '{{count}} years ago',
    aquariumListRecentParametersTitle: 'Recent parameters',
    aquariumListParameterPh: 'pH',
    aquariumListParameterTemperature: 'Temp',
    aquariumListParameterNitrate: 'NO3',
    aquariumStatusActive: 'Active',
    aquariumStatusInactive: 'Inactive',
    aquariumStatusArchived: 'Archived',
    aquariumListDetailsAction: 'View Details',
    aquariumListDetailsActionAria: 'View details for aquarium {{name}}',
    aquariumListTypeLoadingHint: 'Loading aquarium types...',
    aquariumListTypeLoadErrorHint: 'Could not load aquarium types. Try again.',
    aquariumListLoadErrorTitle: 'Could not load aquariums',
    aquariumListLoadErrorDescription:
      'Try again in a moment to fetch the latest list from the API.',
    aquariumListTotalLabel: 'Total',
    aquariumListCombinedVolumeLabel: 'Combined volume',
    aquariumListAquariumSingular: 'aquarium',
    aquariumListAquariumPlural: 'aquariums',
    aquariumListEmptyTitle: 'No aquariums registered',
    aquariumListEmptyDescription: 'Add your first aquarium to start monitoring water parameters.',
  ...
  es: {
    ...
    homeAquariumFiltersSearchLabel: 'Buscar por nombre',
    homeAquariumFiltersSearchPlaceholder: 'Ej.: Comunitario, Plantado, Arrecife',
    homeAquariumFiltersTypeLabel: 'Tipo de acuario',
    homeAquariumFiltersTypePlaceholder: 'Todos los tipos',
    homeAquariumFiltersDateFromLabel: 'Fecha inicial',
    homeAquariumFiltersDateToLabel: 'Fecha final',
    homeAquariumFiltersDatePlaceholder: 'Selecciona la fecha',
    homeAquariumFiltersDateHint:
      'El filtro por fecha se habilitará cuando la API envíe la fecha del acuario.',
    homeAquariumFiltersEmptyTitle: 'No se encontraron acuarios',
    homeAquariumFiltersEmptyDesc:
      'Ajusta la búsqueda o el tipo seleccionado para encontrar un acuario.',
    ...
    // Aquarium — create page
    aquariumFormTitle: 'Agregar Nuevo Acuario',
    aquariumCreateSubtitle:
      'Configura un nuevo acuario para empezar a seguir los parámetros del agua',
    aquariumCreateBackToAquariums: 'Volver a Acuarios',
    aquariumCreateBasicInfoTitle: 'Información Básica',
    aquariumCreateNameLabel: 'Nombre del Acuario',
    aquariumCreateNamePlaceholder: 'ej.: Comunitario 60L, Plantado de la Sala, Reef Paradise',
    aquariumCreateTypeLabel: 'Tipo de Acuario',
    aquariumCreateTypeHint: 'Selecciona la configuración que mejor representa tu acuario.',
    aquariumCreateTypeSelectWaterTypeHint:
      'Selecciona primero el tipo de agua para habilitar los tipos de acuario compatibles.',
    aquariumCreateTypeLoadingHint: 'Cargando los tipos de acuario disponibles...',
    aquariumCreateTypeLoadErrorHint: 'No se pudieron cargar los tipos de acuario en este momento.',
    aquariumCreateTypeBreeding: 'Reproducción',
    aquariumCreateTypeCrabs: 'Cangrejos',
    aquariumCreateTypeCommunity: 'Comunitario',
    aquariumCreateTypeCommunityTank: 'Acuario Comunitario',
    aquariumCreateTypeHospital: 'Hospital',
    aquariumCreateTypeLake: 'Lago',
    aquariumCreateTypeOther: 'Otro',
    aquariumCreateTypePaludarium: 'Paludario',
    aquariumCreateTypeFreshwater: 'Agua Dulce',
    aquariumCreateTypeFreshwaterDescription: 'Acuario estándar de agua dulce',
    aquariumCreateTypePlanted: 'Plantado',
    aquariumCreateTypePlantedTank: 'Acuario Plantado',
    aquariumCreateTypePlantedDescription: 'Aquascaping con plantas vivas',
    aquariumCreateTypeReef: 'Arrecife',
    aquariumCreateTypeReefTank: 'Acuario de Arrecife',
    aquariumCreateTypeSaltwater: 'Agua Salada',
    aquariumCreateTypeSaltwaterDescription: 'Acuario marino o de arrecife',
    aquariumCreateTypeShrimp: 'Acuario de Camarones',
    aquariumCreateTypeShrimpTank: 'Acuario de Camarones',
    aquariumCreateTypeShrimpDescription: 'Especializado para reproducción de camarones',
    aquariumCreateTypeSpeciesOnly: 'Solo Una Especie',
    aquariumCreateTypeTurtle: 'Acuario de Tortugas',
    aquariumCreateTypeTurtleTank: 'Acuario de Tortugas',
    aquariumCreateTypeTurtleDescription: 'Configuración para tortugas acuáticas',
    aquariumCreateWaterTypeLabel: 'Tipo de Agua',
    aquariumCreateWaterTypeHint: 'Selecciona el tipo de agua utilizado en este acuario.',
    aquariumCreateWaterTypeLoadingHint: 'Cargando los tipos de agua disponibles...',
    aquariumCreateWaterTypeLoadErrorHint:
      'No se pudieron cargar los tipos de agua en este momento.',
    aquariumCreateWaterTypeFreshwaterDescription: 'Ideal para peces y plantas de agua dulce',
    aquariumCreateWaterTypeSaltwaterDescription: 'Recomendado para acuarios marinos o de arrecife',
    aquariumCreateWaterTypeBrackishDescription: 'Mezcla de agua dulce y salada',
    aquariumCreateSetupDateLabel: 'Fecha de Inicio',
    aquariumCreateSetupDatePlaceholder: 'Selecciona la fecha',
    aquariumCreateDimensionsTitle: 'Dimensiones',
    aquariumCreateDimensionsSubtitle:
      'Elige entre informar las dimensiones físicas del acuario o solo el volumen total.',
    aquariumCreateDimensionModeLabel: 'Informar dimensiones físicas',
    aquariumCreateDimensionModeHint: 'Activa para completar ancho, largo y altura.',
    aquariumCreateDimensionModeVolumeHint: 'Desactiva para informar solo el volumen total.',
    aquariumCreateLengthLabel: 'Largo (cm)',
    aquariumCreateLengthPlaceholder: 'ej.: 90',
    aquariumCreateWidthLabel: 'Ancho (cm)',
    aquariumCreateWidthPlaceholder: 'ej.: 45',
    aquariumCreateHeightLabel: 'Altura (cm)',
    aquariumCreateHeightPlaceholder: 'ej.: 50',
    aquariumCreateVolumeLabel: 'Volumen (L)',
    aquariumCreateVolumePlaceholder: 'ej.: 72',
    aquariumCreateVolumeCalculatedLabel: 'Volumen calculado',
    aquariumCreateVolumeProvidedLabel: 'Volumen informado',
    aquariumCreateVolumeUnitLiters: 'litros',
    aquariumCreateVolumeFormula: 'Fórmula: largo × ancho × altura ÷ 1000',
    aquariumCreateDisplayParametersTitle: 'Parámetros en el Dashboard',
    aquariumCreateDisplayParametersSubtitle:
    ...
    aquariumCreateDescriptionPlaceholder: 'Agrega notas u observaciones sobre este acuario...',
    aquariumCreatePhotoTitle: 'Foto del Acuario',
    aquariumCreatePhotoSubtitle: 'Opcional: agrega una foto de tu acuario.',
    aquariumCreatePhotoDropLabel: 'Suelta tu imagen aquí o',
    aquariumCreatePhotoBrowseLabel: 'búscala en tu equipo',
    aquariumCreatePhotoHint: 'Formatos aceptados: JPG, PNG, WebP. Tamaño máximo 5MB.',
    ...
    aquariumListPageSubtitle: 'Monitorea y revisa la vista general de tus acuarios.',
    aquariumListAddAction: 'Agregar Acuario',
    aquariumListVolumeLabel: 'Volumen',
    aquariumListInstalledLabel: 'Instalado',
    aquariumListInstalledMonthSingular: 'hace 1 mes',
    aquariumListInstalledMonthPlural: 'hace {{count}} meses',
    aquariumListInstalledYearSingular: 'hace 1 año',
    aquariumListInstalledYearPlural: 'hace {{count}} años',
    aquariumListRecentParametersTitle: 'Parámetros recientes',
    aquariumListParameterPh: 'pH',
    aquariumListParameterTemperature: 'Temp',
    aquariumListParameterNitrate: 'NO3',
    aquariumStatusActive: 'Activo',
    aquariumStatusInactive: 'Inactivo',
    aquariumStatusArchived: 'Archivado',
    aquariumListDetailsAction: 'Ver Detalles',
    aquariumListDetailsActionAria: 'Ver detalles del acuario {{name}}',
    aquariumListTypeLoadingHint: 'Cargando tipos...',
    aquariumListTypeLoadErrorHint:
      'No se pudieron cargar los tipos de acuario. Inténtalo de nuevo.',
    aquariumListLoadErrorTitle: 'No se pudieron cargar los acuarios',
    aquariumListLoadErrorDescription:
      'Inténtalo de nuevo en unos instantes para buscar la lista actualizada desde la API.',
    aquariumListTotalLabel: 'Total',
    aquariumListCombinedVolumeLabel: 'Volumen combinado',
    aquariumListAquariumSingular: 'acuario',
    aquariumListAquariumPlural: 'acuarios',
    aquariumListEmptyTitle: 'No hay acuarios registrados',
    aquariumListEmptyDescription:
      'Agrega tu primer acuario para empezar a monitorear los parámetros del agua.',
