...
import { MeasurementCreatePageComponent } from './measurement-create-page.component';
...
async function createFixture(
...
): Promise<ComponentFixture<MeasurementCreatePageComponent>> {
  await TestBed.configureTestingModule({
    imports: [MeasurementCreatePageComponent],
    providers: [
      provideRouter([]),
  ...
  const fixture = TestBed.createComponent(MeasurementCreatePageComponent);
  fixture.detectChanges();
  return fixture;
}

describe('MeasurementCreatePageComponent', () => {
  ...
  it('should set the page title', async () => {
    ...
    expect(pageTitleMock.set).toHaveBeenCalledWith('Nova Medição');
  });

  it('should render the coming soon message', async () => {
    const fixture = await createFixture(buildPageTitleMock());
    expect(fixture.nativeElement.textContent).toContain(
      'O formulário de cadastro de medição estará disponível em breve.',
    );
  });
