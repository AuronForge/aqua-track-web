...
async function createFixture(
...
): Promise<ComponentFixture<ApplicationCreatePageComponent>> {
  ...
  const fixture = TestBed.createComponent(ApplicationCreatePageComponent);
...
describe('ApplicationCreatePageComponent', () => {
  ...
  it('should set the page title', async () => {
    ...
    expect(pageTitleMock.set).toHaveBeenCalledWith('Nova Aplicação');
  });

  it('should render the coming soon message', async () => {
    const fixture = await createFixture(buildPageTitleMock());
    expect(fixture.nativeElement.textContent).toContain(
      'O formulário de cadastro de aplicação estará disponível em breve.',
    );
  });
